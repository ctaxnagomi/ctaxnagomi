...
|| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
||| 🎚️ **Colorblind Mode Toggle**               | Accessible Light/Dark/Colorblind theme toggle for web and WordPress with colorblind subtypes and keyboard support; persists via localStorage.                                                                | HTML, CSS, JavaScript, WordPress                   | Shortcode: `[mode_toggle]` · Classes: `theme-light`, `theme-dark`, `theme-cb`, `cb-*` · Persistence: `a11y.theme`, `a11y.cbType` · Demo: `web/index.html`                                 | ✔️ Complete |
