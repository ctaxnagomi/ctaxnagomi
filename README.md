...
|| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
|| 🎚️ **Accessibility Theme Mode Toggle**        | Accessible Light/Dark/Colorblind theme toggle for web and WordPress with colorblind subtypes and keyboard support; persists via localStorage.                                                                | HTML, CSS, JavaScript, WordPress                   | Shortcode: `[mode_toggle]` · Classes: `theme-light`, `theme-dark`, `theme-cb`, `cb-*` · Persistence: `a11y.theme`, `a11y.cbType` · Demo: `web/index.html`                                 | ✔️ Complete |
||  |  |  | [![Release](https://img.shields.io/github/v/release/ctaxnagomi/dark-light-colorblind-mode?sort=semver)](https://github.com/ctaxnagomi/dark-light-colorblind-mode/releases) [![Package ZIP](https://github.com/ctaxnagomi/dark-light-colorblind-mode/actions/workflows/release-package.yml/badge.svg)](https://github.com/ctaxnagomi/dark-light-colorblind-mode/actions/workflows/release-package.yml) |  |
